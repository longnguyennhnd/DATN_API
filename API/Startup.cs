...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<INghiPhepBusiness, NghiPhepBusiness>();
            services.AddTransient<INghiPhepRepository, NghiPhepRepository>();
            services.AddTransient<IGopYBusiness, GopYBusiness>();
            services.AddTransient<IGopYRespository, GopYRespository>();
